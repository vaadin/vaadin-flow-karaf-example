...
export class ConnectClient {
    ...
    loadingStarted() {
        ...
        if (this.isFlowLoaded()) {
            ...
            (_b = (_a = $wnd.Vaadin.Flow.clients) === null || _a === void 0 ? void 0 : _a.TypeScript) === null || _b === void 0 ? void 0 : _b.loadingStarted();
        }
        else {
    ...
    loadingFinished() {
        ...
        if (this.isFlowLoaded()) {
            ...
            // requests are ongoing
            (_b = (_a = $wnd.Vaadin.Flow.clients) === null || _a === void 0 ? void 0 : _a.TypeScript) === null || _b === void 0 ? void 0 : _b.loadingFinished();
        }
        else {
